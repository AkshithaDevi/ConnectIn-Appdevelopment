...
const Skills = () => {
  ...
  const fetchSkills = async () => {
    try {
      const response = await fetch(`https://mevn.in/apps/indeed/connectin/fetchSkills.php?username=${username}`);
  ...
  const handleSubmit = async () => {
    try {
      const response = await fetch(`https://mevn.in/apps/indeed/connectin/skills.php?username=${username}&skill=${encodeURIComponent(skill)}`);
