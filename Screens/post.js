...
export default function App() {
  ...
  const uploadImage = async (uri) => {
    ...
    try {
        ...
        const url = `https://mevn.in/apps/indeed/connectin/Addpost.php?username=${encodeURIComponent(username)}&caption=${encodeURIComponent(caption)}&content=${encodeURIComponent(content)}`;
        ...
        const response = await fetch('https://mevn.in/apps/indeed/connectin/post.php', {
        method: 'POST',
        body: formData,
        headers: {
